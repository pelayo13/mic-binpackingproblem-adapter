...
public interface BppInstanceGrpcMapper {
  ...
  List<BppDetailedSolution> toBppDetailedSolutions(
      List<BppDetailedSolutionProto.BppDetailedSolution> bppDetailedSolutionsProto);

  @Mapping(target = "recordInstances", source = "recordInstancesList")
  BppDetailedSolution toBppDetailedSolutions(
      BppDetailedSolutionProto.BppDetailedSolution bppDetailedSolutionsProto);
